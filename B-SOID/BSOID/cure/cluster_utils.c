...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "BSOID.cure.cluster_utils",
        "sources": [
            "/Users/dhruvlaad/IIT/DDP/DDP/B-SOID/BSOID/cure/cluster_utils.pyx"
        ]
    },
    "module_name": "BSOID.cure.cluster_utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__BSOID__cure__cluster_utils
#define __PYX_HAVE_API__BSOID__cure__cluster_utils
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'BSOID.cure.cluster_utils' */
...
static double __pyx_f_5BSOID_4cure_13cluster_utils_dense_dist_mat_at_ij(__Pyx_memviewslice, int, int, int); /*proto*/
static PyObject *__pyx_f_5BSOID_4cure_13cluster_utils_well_scattered_points(int, PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "BSOID.cure.cluster_utils"
extern int __pyx_module_is_main_BSOID__cure__cluster_utils;
int __pyx_module_is_main_BSOID__cure__cluster_utils = 0;

/* Implementation of 'BSOID.cure.cluster_utils' */
...
static PyObject *__pyx_pf_5BSOID_4cure_13cluster_utils_well_scattered_points(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n_rep, PyArrayObject *__pyx_v_mean, PyArrayObject *__pyx_v_data); /* proto */
...
/* "BSOID/cure/cluster_utils.pyx":5
...
static double __pyx_f_5BSOID_4cure_13cluster_utils_dense_dist_mat_at_ij(__Pyx_memviewslice __pyx_v_dist, int __pyx_v_i, int __pyx_v_j, int __pyx_v_n) {
  int __pyx_v_idx;
  double __pyx_r;
  ...
  /* "BSOID/cure/cluster_utils.pyx":7
 * cdef double dense_dist_mat_at_ij(double[:] dist, int i, int j, int n):
 *     cdef int idx
 *     if i < j:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "BSOID/cure/cluster_utils.pyx":8
 *     cdef int idx
 *     if i < j:
 *         idx = i*n - i*(i+1) // 2 - (j-i-1)             # <<<<<<<<<<<<<<
 *     elif i > j:
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":9
 *     if i < j:
 *         idx = i*n - i*(i+1) // 2 - (j-i-1)
 *     elif i > j:             # <<<<<<<<<<<<<<
 *         idx = j*n - j*(j+1) // 2 - (i-j-1)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "BSOID/cure/cluster_utils.pyx":10
 *         idx = i*n - i*(i+1) // 2 - (j-i-1)
 *     elif i > j:
 *         idx = j*n - j*(j+1) // 2 - (i-j-1)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":12
 *         idx = j*n - j*(j+1) // 2 - (i-j-1)
 *     else:
 *         return 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":14
 *         return 0.0
 * 
 *     return dist[idx]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("BSOID.cure.cluster_utils.dense_dist_mat_at_ij", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
/* "BSOID/cure/cluster_utils.pyx":16
 *     return dist[idx]
 * 
 * cpdef tuple well_scattered_points(int n_rep, np.ndarray[np.double_t, ndim=1] mean, np.ndarray[np.double_t, ndim=2] data):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_5BSOID_4cure_13cluster_utils_1well_scattered_points(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_5BSOID_4cure_13cluster_utils_well_scattered_points(int __pyx_v_n_rep, PyArrayObject *__pyx_v_mean, PyArrayObject *__pyx_v_data, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_n;
  ...
  /* "BSOID/cure/cluster_utils.pyx":17
 * 
 * cpdef tuple well_scattered_points(int n_rep, np.ndarray[np.double_t, ndim=1] mean, np.ndarray[np.double_t, ndim=2] data):
 *     cdef int n = data.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":20
 * 
 *     # if the cluster contains less than no. of rep points, all points are rep points
 *     if n <= n_rep:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "BSOID/cure/cluster_utils.pyx":21
 *     # if the cluster contains less than no. of rep points, all points are rep points
 *     if n <= n_rep:
 *         return list(data), np.arange(data.shape[0])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":23
 *         return list(data), np.arange(data.shape[0])
 * 
 *     cdef double[:] distances = pdist(data)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":25
 *     cdef double[:] distances = pdist(data)
 * 
 *     cdef int idx = np.argmax(np.linalg.norm(data - mean, axis=1))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":28
 * 
 *     # keep track of distances to scattered points as they are identified
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":30
 *     cdef np.ndarray[np.double_t, ndim=2] dist_to_scatter = -1.0*np.ones((n_rep, n)).astype(np.float64)
 * 
 *     cdef list scatter_idx = [idx]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":34
 *     cdef double min_dist, max_dist, dist
 * 
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_12; __pyx_t_9+=1) {
    ...
    /* "BSOID/cure/cluster_utils.pyx":35
 * 
 *     for i in range(n_rep-1):
 *         max_dist = 0.0             # <<<<<<<<<<<<<<
 *         for j in range(n):
 ...
 */
    ...
    /* "BSOID/cure/cluster_utils.pyx":36
 *     for i in range(n_rep-1):
 *         max_dist = 0.0
 *         for j in range(n):             # <<<<<<<<<<<<<<
 *             # calculate distance of point to latest scatter point
 ...
 */
    ...
    for (__pyx_t_15 = 0; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
      ...
      /* "BSOID/cure/cluster_utils.pyx":38
 *         for j in range(n):
 *             # calculate distance of point to latest scatter point
 *             dist_to_scatter[i,j] = dense_dist_mat_at_ij(distances, scatter_idx[-1], j, n)             # <<<<<<<<<<<<<<
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_double_t *, __pyx_pybuffernd_dist_to_scatter.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_dist_to_scatter.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_dist_to_scatter.diminfo[1].strides) = __pyx_f_5BSOID_4cure_13cluster_utils_dense_dist_mat_at_ij(__pyx_v_distances, __pyx_t_16, __pyx_v_j, __pyx_v_n);

      /* "BSOID/cure/cluster_utils.pyx":40
 *             dist_to_scatter[i,j] = dense_dist_mat_at_ij(distances, scatter_idx[-1], j, n)
 *             # minimum distance of point from scattered points
 *             min_dist = np.min(dist_to_scatter[:i+1,j])             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "BSOID/cure/cluster_utils.pyx":41
 *             # minimum distance of point from scattered points
 *             min_dist = np.min(dist_to_scatter[:i+1,j])
 *             if min_dist > max_dist:             # <<<<<<<<<<<<<<
 *                 max_dist = min_dist
 ...
 */
      ...
      if (__pyx_t_1) {
        ...
        /* "BSOID/cure/cluster_utils.pyx":42
 *             min_dist = np.min(dist_to_scatter[:i+1,j])
 *             if min_dist > max_dist:
 *                 max_dist = min_dist             # <<<<<<<<<<<<<<
 *                 max_point = j
 ...
 */
        ...
        /* "BSOID/cure/cluster_utils.pyx":43
 *             if min_dist > max_dist:
 *                 max_dist = min_dist
 *                 max_point = j             # <<<<<<<<<<<<<<
 *         scatter_idx.append(max_point)
 ...
 */
    ...
    /* "BSOID/cure/cluster_utils.pyx":44
 *                 max_dist = min_dist
 *                 max_point = j
 *         scatter_idx.append(max_point)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":46
 *         scatter_idx.append(max_point)
 * 
 *     return [data[i] for i in scatter_idx], scatter_idx             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_AddTraceback("BSOID.cure.cluster_utils.well_scattered_points", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_data.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_5BSOID_4cure_13cluster_utils_1well_scattered_points(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_5BSOID_4cure_13cluster_utils_1well_scattered_points(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_n_rep;
  ...
  __pyx_r = __pyx_pf_5BSOID_4cure_13cluster_utils_well_scattered_points(__pyx_self, __pyx_v_n_rep, __pyx_v_mean, __pyx_v_data);
...
static PyObject *__pyx_pf_5BSOID_4cure_13cluster_utils_well_scattered_points(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_n_rep, PyArrayObject *__pyx_v_mean, PyArrayObject *__pyx_v_data) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_data;
  __Pyx_Buffer __pyx_pybuffer_data;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_mean;
  __Pyx_Buffer __pyx_pybuffer_mean;
  ...
  __pyx_pybuffernd_data.diminfo[0].strides = __pyx_pybuffernd_data.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_data.diminfo[0].shape = __pyx_pybuffernd_data.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_data.diminfo[1].strides = __pyx_pybuffernd_data.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_data.diminfo[1].shape = __pyx_pybuffernd_data.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_5BSOID_4cure_13cluster_utils_well_scattered_points(__pyx_v_n_rep, __pyx_v_mean, __pyx_v_data, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "BSOID.cure.cluster_utils.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "BSOID.cure.cluster_utils.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "BSOID.cure.cluster_utils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "BSOID.cure.cluster_utils._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"well_scattered_points", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5BSOID_4cure_13cluster_utils_1well_scattered_points, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_BSOID__cure__cluster_utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "BSOID.cure.cluster_utils")) {
      if (unlikely(PyDict_SetItemString(modules, "BSOID.cure.cluster_utils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "BSOID/cure/cluster_utils.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * from scipy.spatial.distance import pdist
 */
  ...
  /* "BSOID/cure/cluster_utils.pyx":3
 * import numpy as np
 * cimport numpy as np
 * from scipy.spatial.distance import pdist             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init BSOID.cure.cluster_utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init BSOID.cure.cluster_utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
