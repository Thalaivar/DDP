...
def cluster_all_together(templates, umap_params, hdbscan_params, scale, verbose=False):
    embeddings, clustering = get_clusters(templates, hdbscan_params, umap_params, scale, verbose, return_embedding=True)
    return embeddings, clustering